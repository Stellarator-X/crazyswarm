...
class Crazyflie:
    ...
    def __init__(self, id, initialPosition, tf):
        ...
        self.notifySetpointsStopService = rospy.ServiceProxy(
            prefix + "/notify_setpoints_stop", NotifySetpointsStop
        )
        ...
        self.cmdPositionPublisher = rospy.Publisher(
            prefix + "/cmd_position", Position, queue_size=1
        )
    ...
    def goTo(self, goal, yaw, duration, relative=False, groupMask=0):
        ...
        self.goToService(
            groupMask, relative, gp, yaw, rospy.Duration.from_sec(duration)
        )
...
class CrazyflieServer:
    ...
    def __init__(self, crazyflies_yaml="../launch/crazyflies.yaml"):
        ...
        self.startTrajectoryService = rospy.ServiceProxy(
            "/start_trajectory", StartTrajectory
        )
