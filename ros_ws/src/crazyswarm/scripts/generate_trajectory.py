#!/usr/bin/env python
# Original Version : https://github.com/whoenig/uav_trajectories/blob/main/scripts/generate_trajectory.py
...
import uav_trajectoryv2 as uav_trajectory
...
def generate_trajectory(data, num_pieces=5):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "output", type=str, help="CSV file containing trajectory with updated yaw"
    )
